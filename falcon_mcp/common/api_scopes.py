...
API_SCOPE_REQUIREMENTS = {
    ...
    # Certificate Based Exclusions operations
    ...
    # MSSP (Flight Control) operations
    ...
    "entities_classification_patch_v2": ["Data Protection Config:write"],
    "entities_classification_delete_v2": ["Data Protection Config:write"],
    "entities_cloud_application_get": ["Data Protection Config:read"],
    "entities_cloud_application_create": ["Data Protection Config:write"],
    "entities_cloud_application_patch": ["Data Protection Config:write"],
    "entities_cloud_application_delete": ["Data Protection Config:write"],
    "entities_content_pattern_get": ["Data Protection Config:read"],
    "entities_content_pattern_create": ["Data Protection Config:write"],
    "entities_content_pattern_patch": ["Data Protection Config:write"],
    "entities_content_pattern_delete": ["Data Protection Config:write"],
    "entities_policy_precedence_post_v1": ["Data Protection Config:write"],
    "entities_enterprise_account_get": ["Data Protection Config:read"],
    "entities_enterprise_account_create": ["Data Protection Config:write"],
    "entities_enterprise_account_patch": ["Data Protection Config:write"],
    "entities_enterprise_account_delete": ["Data Protection Config:write"],
    "entities_file_type_get": ["Data Protection Config:read"],
    "entities_sensitivity_label_get_v2": ["Data Protection Config:read"],
    "entities_sensitivity_label_create_v2": ["Data Protection Config:write"],
    "entities_sensitivity_label_delete_v2": ["Data Protection Config:write"],
    "entities_local_application_group_get": ["Data Protection Config:read"],
    "entities_local_application_group_create": ["Data Protection Config:write"],
    "entities_local_application_group_patch": ["Data Protection Config:write"],
    "entities_local_application_group_delete": ["Data Protection Config:write"],
    "entities_local_application_get": ["Data Protection Config:read"],
    "entities_local_application_create": ["Data Protection Config:write"],
    "entities_local_application_patch": ["Data Protection Config:write"],
    "entities_local_application_delete": ["Data Protection Config:write"],
    "entities_policy_get_v2": ["Data Protection Config:read"],
    "entities_policy_post_v2": ["Data Protection Config:write"],
    "entities_policy_patch_v2": ["Data Protection Config:write"],
    "entities_policy_delete_v2": ["Data Protection Config:write"],
    "entities_web_location_get_v2": ["Data Protection Config:read"],
    "entities_web_location_create_v2": ["Data Protection Config:write"],
    "entities_web_location_patch_v2": ["Data Protection Config:write"],
    "entities_web_location_delete_v2": ["Data Protection Config:write"],
    "queries_classification_get_v2": ["Data Protection Config:read"],
    "queries_cloud_application_get_v2": ["Data Protection Config:read"],
    "queries_content_pattern_get_v2": ["Data Protection Config:read"],
    "queries_enterprise_account_get_v2": ["Data Protection Config:read"],
    "queries_file_type_get_v2": ["Data Protection Config:read"],
    "queries_sensitivity_label_get_v2": ["Data Protection Config:read"],
    "queries_local_application_group_get": ["Data Protection Config:read"],
    "queries_local_application_get": ["Data Protection Config:read"],
    "queries_policy_get_v2": ["Data Protection Config:read"],
    "queries_web_location_get_v2": ["Data Protection Config:read"],
